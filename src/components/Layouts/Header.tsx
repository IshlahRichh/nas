                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={<img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={currentUser?.avatar || "/assets/images/profile.png"} alt="userProfile" />}
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src={currentUser?.avatar || "/assets/images/profile.png"} alt="userProfile" />
                                            <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 className="text-base">
                                                    {currentUser?.name || 'User'}
                                                    {currentUser?.role === 'admin' && (
                                                        <span className="text-xs bg-danger-light rounded text-danger px-1 ltr:ml-2 rtl:ml-2">Admin</span>
                                                    )}
                                                </h4>
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        <button
                                            ...
                                            className="text-danger !py-3 w-full"
                                        >
